...
An offline AI-powered smart home virtual assistant — voice-controlled (STT/TTS) desktop prototype with local LLM (Ollama + Qwen 2.5) intent parsing and a real-time Tkinter/Pygame dashboard. Prelim Mini-Project, AI Lab.
...
Built as a Prelim Mini-Project (Pair Programming) for BSCS 3112 (9420-AY126)

Team: De Dios, Louise Jeanne & Mangubat, Angel Julliane
